...
let myData = JSON.parse(moovies);
var text = "";

//looping the cards and manipulation
  ...
  <div class="row g-1 container-fluid bg-card ">
    ...
    <div class="col-md-8 d-flex align-items-start">
      <div class="card-body">
        ...
        Like
        <span class ="likesCount">${val.likes}</span>
...
//targeting the value
var value = document.getElementsByClassName("likesCount");

//targeting the button
var btns = document.getElementsByClassName("btnShow");




//updating the likes Starts
...
function getLike(index) {
  var dataLikes = Number(value[index].innerHTML) + 1;
  value[index].innerHTML = dataLikes;
  myData[index].likes = dataLikes;
}
//updating the likes ends
